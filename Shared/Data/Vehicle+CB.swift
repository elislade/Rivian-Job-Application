...
extension CBUUID {
    ...
    static func main_id(for v: Vehicle) -> CBUUID {
    ...
    static func main_action_id(for v: Vehicle) -> CBUUID {
    ...
    static func main_location_id(for v: Vehicle) -> CBUUID {
...
extension CBMutableService {
    ...
    static func main(for v: Vehicle) -> CBMutableService {
...
extension CBMutableCharacteristic {
    ...
    static func main_action(for v: Vehicle) -> CBMutableCharacteristic {
    ...
    static func main_location(for v: Vehicle) -> CBMutableCharacteristic {
